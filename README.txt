# The following project is from code academy.com, and is designed to create multiple classes, instances of those classes, and various class methods. Try to recreate this project based on the text below!
